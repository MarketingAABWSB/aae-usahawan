      ...
      <footer style={{ background: 'var(--bg-primary)', padding: '60px 0', borderTop: '1px solid var(--border-subtle)' }}>
        <div className="container center">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '15px' }}>
            <a href="https://www.tiktok.com/@acond.auto.expert" style={{ color: 'var(--text-muted)', transition: 'color 0.2s ease' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--text-primary)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-muted)'} aria-label="TikTok" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.facebook.com/profile.php?id=61584142345060&mibextid=wwXIfr&rdid=Pn6oXsAQyeH4lPBE&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F19YXpFWLvd%2F%3Fmibextid%3DwwXIfr#" style={{ color: 'var(--text-muted)', transition: 'color 0.2s ease' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--text-primary)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-muted)'} aria-label="Facebook" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
            </a>
          </div>
        </div>
      </footer>
